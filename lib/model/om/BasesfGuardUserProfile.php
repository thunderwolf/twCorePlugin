...
abstract class BasesfGuardUserProfile extends BaseObject  implements Persistent
{
  ...
  const PEER = 'sfGuardUserProfilePeer';
	...
	public function setAssetId($v)
	{
		...
		if ($this->asset_id !== $v) {
			$this->asset_id = $v;
			$this->modifiedColumns[] = sfGuardUserProfilePeer::ASSET_ID;
		}

		if ($this->atwAsset !== null && $this->atwAsset->getId() !== $v) {
			$this->atwAsset = null;
		}
	...
	public function setAlias($v)
	{
		...
		if ($this->alias !== $v) {
			$this->alias = $v;
			$this->modifiedColumns[] = sfGuardUserProfilePeer::ALIAS;
		}
	...
	public function ensureConsistency()
	{
		...
		if ($this->atwAsset !== null && $this->asset_id !== $this->atwAsset->getId()) {
			$this->atwAsset = null;
		}
	} // ensureConsistency
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->atwAsset !== null) {
				if ($this->atwAsset->isModified() || $this->atwAsset->isNew()) {
					$affectedRows += $this->atwAsset->save($con);
				}
				$this->settwAsset($this->atwAsset);
			}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if ($this->atwAsset !== null) {
				if (!$this->atwAsset->validate($columns)) {
					$failureMap = array_merge($failureMap, $this->atwAsset->getValidationFailures());
				}
			}
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $includeForeignObjects = false)
	{
		...
		if ($includeForeignObjects) {
			...
			if (null !== $this->atwAsset) {
				$result['twAsset'] = $this->atwAsset->toArray($keyType, $includeLazyLoadColumns, true);
			}
		}
		return $result;
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(sfGuardUserProfilePeer::ASSET_ID)) $criteria->add(sfGuardUserProfilePeer::ASSET_ID, $this->asset_id);
		...
		if ($this->isColumnModified(sfGuardUserProfilePeer::ALIAS)) $criteria->add(sfGuardUserProfilePeer::ALIAS, $this->alias);
	...
	/**
	 * Declares an association between this object and a twAsset object.
	 *
	 * @param      twAsset $v
	 * @return     sfGuardUserProfile The current object (for fluent API support)
	 * @throws     PropelException
	 */
	public function settwAsset(twAsset $v = null)
	{
		if ($v === null) {
		...
		// If this object has already been added to the twAsset object, it will not be re-added.
		if ($v !== null) {
	...
	/**
	 * Get the associated twAsset object
	 *
	 * @param      PropelPDO Optional Connection object.
	 * @return     twAsset The associated twAsset object.
	 * @throws     PropelException
	 */
	public function gettwAsset(PropelPDO $con = null)
	{
		if ($this->atwAsset === null && ($this->asset_id !== null)) {
			$this->atwAsset = twAssetQuery::create()->findPk($this->asset_id);
			/* The following can be used additionally to
			   guarantee the related object contains a reference
			   to this object.  This level of coupling may, however, be
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->atwAsset->addsfGuardUserProfiles($this);
			 */
		}
		return $this->atwAsset;
	}
