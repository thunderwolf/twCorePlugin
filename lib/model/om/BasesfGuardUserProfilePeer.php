...
abstract class BasesfGuardUserProfilePeer {
	...
	const CLASS_DEFAULT = 'plugins.twCorePlugin.lib.model.sfGuardUserProfile';
	...
	const ASSET_ID = 'sf_guard_user_profile.ASSET_ID';
	...
	const ALIAS = 'sf_guard_user_profile.ALIAS';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('UserId', 'AssetId', 'Email', 'FirstName', 'LastName', 'Birthday', 'Alias', 'Culture', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('userId', 'assetId', 'email', 'firstName', 'lastName', 'birthday', 'alias', 'culture', ),
		BasePeer::TYPE_COLNAME => array (self::USER_ID, self::ASSET_ID, self::EMAIL, self::FIRST_NAME, self::LAST_NAME, self::BIRTHDAY, self::ALIAS, self::CULTURE, ),
		BasePeer::TYPE_RAW_COLNAME => array ('USER_ID', 'ASSET_ID', 'EMAIL', 'FIRST_NAME', 'LAST_NAME', 'BIRTHDAY', 'ALIAS', 'CULTURE', ),
		BasePeer::TYPE_FIELDNAME => array ('user_id', 'asset_id', 'email', 'first_name', 'last_name', 'birthday', 'alias', 'culture', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('UserId' => 0, 'AssetId' => 1, 'Email' => 2, 'FirstName' => 3, 'LastName' => 4, 'Birthday' => 5, 'Alias' => 6, 'Culture' => 7, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('userId' => 0, 'assetId' => 1, 'email' => 2, 'firstName' => 3, 'lastName' => 4, 'birthday' => 5, 'alias' => 6, 'culture' => 7, ),
		BasePeer::TYPE_COLNAME => array (self::USER_ID => 0, self::ASSET_ID => 1, self::EMAIL => 2, self::FIRST_NAME => 3, self::LAST_NAME => 4, self::BIRTHDAY => 5, self::ALIAS => 6, self::CULTURE => 7, ),
		BasePeer::TYPE_RAW_COLNAME => array ('USER_ID' => 0, 'ASSET_ID' => 1, 'EMAIL' => 2, 'FIRST_NAME' => 3, 'LAST_NAME' => 4, 'BIRTHDAY' => 5, 'ALIAS' => 6, 'CULTURE' => 7, ),
		BasePeer::TYPE_FIELDNAME => array ('user_id' => 0, 'asset_id' => 1, 'email' => 2, 'first_name' => 3, 'last_name' => 4, 'birthday' => 5, 'alias' => 6, 'culture' => 7, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, )
	);
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(sfGuardUserProfilePeer::ASSET_ID);
			...
			$criteria->addSelectColumn(sfGuardUserProfilePeer::ALIAS);
	...
	/**
	 * Returns the number of rows matching criteria, joining the related twAsset table
	 *
	 * @param      Criteria $criteria
	 * @param      boolean $distinct Whether to select only distinct columns; deprecated: use Criteria->setDistinct() instead.
	 * @param      PropelPDO $con
	 ...
	 * @return     int Number of matching rows.
	 */
	public static function doCountJointwAsset(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		// we're going to modify criteria, so copy it first
		$criteria = clone $criteria;
		...
		$criteria->addJoin(sfGuardUserProfilePeer::ASSET_ID, twAssetPeer::ID, $join_behavior);
	...
	/**
	 * Selects a collection of sfGuardUserProfile objects pre-filled with their twAsset objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 * @return     array Array of sfGuardUserProfile objects.
	 ...
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJointwAsset(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$criteria = clone $criteria;
		...
		sfGuardUserProfilePeer::addSelectColumns($criteria);
		$startcol = (sfGuardUserProfilePeer::NUM_COLUMNS - sfGuardUserProfilePeer::NUM_LAZY_LOAD_COLUMNS);
		twAssetPeer::addSelectColumns($criteria);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			$key2 = twAssetPeer::getPrimaryKeyHashFromRow($row, $startcol);
			if ($key2 !== null) {
				$obj2 = twAssetPeer::getInstanceFromPool($key2);
				if (!$obj2) {

					$cls = twAssetPeer::getOMClass(false);

					$obj2 = new $cls();
					$obj2->hydrate($row, $startcol);
					twAssetPeer::addInstanceToPool($obj2, $key2);
				} // if obj2 already loaded

				// Add the $obj1 (sfGuardUserProfile) to $obj2 (twAsset)
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		twAssetPeer::addSelectColumns($criteria);
		$startcol4 = $startcol3 + (twAssetPeer::NUM_COLUMNS - twAssetPeer::NUM_LAZY_LOAD_COLUMNS);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			// Add objects for joined twAsset rows

			$key3 = twAssetPeer::getPrimaryKeyHashFromRow($row, $startcol3);
			if ($key3 !== null) {
				$obj3 = twAssetPeer::getInstanceFromPool($key3);
				if (!$obj3) {
					...
					twAssetPeer::addInstanceToPool($obj3, $key3);
				} // if obj3 loaded

				// Add the $obj1 (sfGuardUserProfile) to the collection in $obj3 (twAsset)
	 ...
	 * @return     int Number of matching rows.
	 */
	public static function doCountJoinAllExcepttwAsset(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		// we're going to modify criteria, so copy it first
		$criteria = clone $criteria;
	...
	public static function doSelectJoinAllExceptsfGuardUser(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		twAssetPeer::addSelectColumns($criteria);
		$startcol3 = $startcol2 + (twAssetPeer::NUM_COLUMNS - twAssetPeer::NUM_LAZY_LOAD_COLUMNS);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if (null !== ($obj1 = sfGuardUserProfilePeer::getInstanceFromPool($key1))) {
				...
				$key2 = twAssetPeer::getPrimaryKeyHashFromRow($row, $startcol2);
				if ($key2 !== null) {
					$obj2 = twAssetPeer::getInstanceFromPool($key2);
					if (!$obj2) {
				...
				// Add the $obj1 (sfGuardUserProfile) to the collection in $obj2 (twAsset)
				$obj2->addsfGuardUserProfile($obj1);
	...
	/**
	 * Selects a collection of sfGuardUserProfile objects pre-filled with all related objects except twAsset.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 ...
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinAllExcepttwAsset(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$criteria = clone $criteria;
    ...
    foreach (sfMixer::getCallables('BasesfGuardUserProfilePeer:doUpdate:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BasesfGuardUserProfilePeer', $values, $con))
      {
		...
		if ($values instanceof Criteria) {
			...
			$value = $criteria->remove(sfGuardUserProfilePeer::USER_ID);
			if ($value) {
				$selectCriteria->add(sfGuardUserProfilePeer::USER_ID, $value, $comparison);
			} else {
