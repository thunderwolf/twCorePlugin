...
<div class="twContainer">
  <a title="thunderwolf website" href="http://www.thunderwolf.net/"><img alt="Thunderwolf" class="twLogo" src="<?php echo $path ?>/tw/images/twLogo.png" /></a>
  <div class="twMessageContainer twAlert">
    <img alt="page not found" class="twMessageIcon" src="<?php echo $path ?>/tw/images/icons/tools48.png" height="48" width="48" />
  ...
  <dl class="twMessageInfo">
    ...
    <dd>
      <ul class="twIconList">
        <li class="twReloadMessage"><a href="javascript:window.location.reload()">Try again: Reload Page</a></li>
      </ul>
    </dd>
  </dl>
</div>
